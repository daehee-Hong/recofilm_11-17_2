...
public class ApiUpComing {
    ...
    public List<MovieDto> movieUpcoming() {
        List<MovieDto> dtoList = new ArrayList<MovieDto>();

        try {
            String getLatestMovie = "https://api.themoviedb.org/3/movie/upcoming?api_key=" + key + language + page + region;
