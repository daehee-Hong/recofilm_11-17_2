...
public class ApiRank {
    ...
    private String page = "&page=1"; //나중에 page값 직접받아서 페이지 조절해야됌
    private String region = "&region=KR";

    public List<MovieDto> movieRank() {
        List<MovieDto> dtoList = new ArrayList<MovieDto>();

        try {
            String getPopularMovie = "https://api.themoviedb.org/3/movie/popular?api_key=" + key + language + page + region;
