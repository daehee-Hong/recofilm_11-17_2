...
@Service
public class ApiSimilarMovie {
    private String key = "857cbf6d4b1cf43fd59a9a85db5d0ccb";
    private String language = "&language=ko-KR";
    private String page = "&page=1";

    public List<MovieDto> similarMovie(int movieid) {
        List<MovieDto> dtoList = new ArrayList<MovieDto>();

        try {
            String getLatestMovie = "https://api.themoviedb.org/3/movie/" + movieid + "/similar?api_key=" + key + language;
