...
public class ApiTopRated {
    ...
    public List<MovieDto> movieTopRated() {
        List<MovieDto> dtoList = new ArrayList<MovieDto>();

        try {
            String getLatestMovie = "https://api.themoviedb.org/3/movie/top_rated?api_key=" + key + language + page + region;
